...
import { ChevronLeft, ChevronRight, Mail, Phone, Linkedin, ExternalLink, Award, Calendar, MapPin, Code, Users, Zap, Eye , Send, User, MessageCircle } from 'lucide-react';
      ...
      <div className="text-center relative z-10">
        ...
        <div className="relative mb-8">
          <div className="w-12 h-12 mx-auto relative">
            ...
            {/* Inner accent */}
            <div className="absolute inset-2 rounded-full border-2 border-transparent border-t-indigo-400 animate-spin" style={{ animationDuration: '1.5s', animationDirection: 'reverse' }}></div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#achievements" className="text-slate-600 hover:text-blue-600 transition-colors font-medium">Achievements</a>
              <a href="#certifications" className="text-slate-600 hover:text-blue-600 transition-colors font-medium">Certifications</a>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
            {projects.map((project) => (
              <div key={project.id} className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-2 border border-slate-100 flex flex-col h-full">
                ...
                <div className="p-6 flex-1 flex flex-col">
                  <div className="flex-1">
                    ...
                    <p className="text-blue-600 font-medium mb-3 text-sm">{project.subtitle}</p>
                    <p className="text-slate-600 mb-4 leading-relaxed text-sm line-clamp-3">{project.description}</p>
                    
                    <div className="mb-4">
                      <h4 className="font-semibold mb-2 text-slate-700 text-sm">Key Features:</h4>
                    ...
                    <div className="flex flex-wrap gap-1 mb-4">
                      {project.tech.slice(0, 4).map((tech, i) => (
                        <span key={i} className="bg-slate-100 text-slate-700 px-2 py-1 rounded-full text-xs font-medium">
                          {tech}
                        </span>
                      ))}
                    </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-4 mb-8">
                <a href="mailto:rushikesh220703@gmail.com" className="flex items-center gap-4 p-4 bg-slate-700 rounded-lg hover:bg-slate-600 transition-colors group">
                ...
                <a href="https://linkedin.com/in/rushikeshraut2212" className="flex items-center gap-4 p-4 bg-slate-700 rounded-lg hover:bg-slate-600 transition-colors group">
                  <div className="bg-blue-600 p-3 rounded-full group-hover:bg-blue-700 transition-colors">
                    <Linkedin size={20} />
                  </div>
                  <div>
              ...
              <div className="text-center lg:text-left">
                <a href="mailto:rushikesh220703@gmail.com" className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full transition-all transform hover:scale-105">
                  <Mail size={16} />
                  Quick Email
                </a>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {submitStatus === 'error' && (
                  <div className="bg-red-600 text-white p-4 rounded-lg text-center">
                    ...
                    <p className="text-sm text-red-100">Please try again or email me directly.</p>
                  </div>
                )}
              </form>
            </div>
